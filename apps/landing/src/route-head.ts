...
export const ROUTE_HEAD: Record<string, RouteHead> = {
  '/': {
    ...
    description:
      'cascivo is the CSS-native, signal-driven, AI-first React design system: owned-code React components, 10 themes, an MCP server, and WCAG 2.2 AA — beautiful by default.',
    ogTitle: 'cascivo',
  },
  '/accessibility': {
