...
| `columnState`         | `ColumnState`                                                                                            | No       | —        | User-adjustable column layout (controlled): `hidden` keys. One object, so it round-trips through storage or a URL as a unit.                                                                                                                                                                                                                                                                               |
...
| `columnSettings`      | `ColumnSettings`                                                                                         | No       | —        | Which column-layout controls to offer: `visibility` adds a "Columns" menu to the toolbar. All off by default.                                                                                                                                                                                                                                                                                              |
