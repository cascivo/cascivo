...
// claims (both let you own code). Ordered strongest-first.
const ROWS: Row[] = [
  { feature: 'Tailwind', cascivo: 'Not required', shadcn: 'Required (v4)' },
  { feature: 'Component styling', cascivo: 'Design tokens + plain CSS', shadcn: 'Utility classes' },
  {
    feature: 'Reactivity',
  ...
  { feature: 'Charts', cascivo: 'Zero-dependency (@cascivo/charts)', shadcn: 'Recharts' },
