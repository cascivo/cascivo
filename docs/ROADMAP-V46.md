...
**Status:** ✅ Shipped — T1–T7 implemented (keymap+history, sync+handle, find/replace, save+seam,
theming+gutter+brackets, markdown+perf+docs, docs & Storybook variants). `@cascivo/editor` 0.1.0; full
`pnpm ready` gate green.
