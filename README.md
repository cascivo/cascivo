...
| [`@cascivo/themes`](packages/themes) | [![npm](https://img.shields.io/npm/v/%40cascivo%2Fthemes?style=flat-square&color=0079bf)](https://www.npmjs.com/package/@cascivo/themes) | First-party cascivo themes: light, dark, warm, flat, minimal, midnight, pastel, brutalist, corporate, terminal, cyberpunk, arcade. Components: @cascivo/react. Docs offline: npx @cascivo/docs |
| [`@cascivo/icons`](packages/icons)   | [![npm](https://img.shields.io/npm/v/%40cascivo%2Ficons?style=flat-square&color=0079bf)](https://www.npmjs.com/package/@cascivo/icons)   | ~440 tree-shakeable SVG icon components for cascivo (SideNav, IconButton, Button). Components: @cascivo/react. Docs offline: npx @cascivo/docs                                                 |

### Components & charts

| Package                              | Version                                                                                                                                  | Description                                                                                                                                                                                             |
| ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`@cascivo/react`](packages/react)   | [![npm](https://img.shields.io/npm/v/%40cascivo%2Freact?style=flat-square&color=0079bf)](https://www.npmjs.com/package/@cascivo/react)   | Prebuilt cascivo design system components — use without copying source. @cascivo/themes installs with it; pair with @cascivo/charts (data-viz) and @cascivo/icons. Docs offline: npx @cascivo/docs      |
...
| [`@cascivo/email`](packages/email)                 | [![npm](https://img.shields.io/npm/v/%40cascivo%2Femail?style=flat-square&color=0079bf)](https://www.npmjs.com/package/@cascivo/email)                 | Render cascivo-themed transactional email — table-based, inline-styled HTML, no client JS, zero runtime dependencies. Conformance-linted against the Can I email matrix. Docs offline: npx @cascivo/docs             |
| [`@cascivo/email-preview`](packages/email-preview) | [![npm](https://img.shields.io/npm/v/%40cascivo%2Femail-preview?style=flat-square&color=0079bf)](https://www.npmjs.com/package/@cascivo/email-preview) | Preview cascivo email templates in a browser — every theme, a viewport switcher, per-client simulation, the encoded-byte gauge, conformance findings, and an .eml download. Run: npx @cascivo/email-preview ./emails |
