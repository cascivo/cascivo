...
export type CascivoToken =
  ...
  | '--cascivo-chart-8'
  | '--cascivo-chart-axis'
  | '--cascivo-chart-fill-opacity'
  | '--cascivo-chart-fill-opacity-overlap'
  | '--cascivo-chart-grid'
  ...
  | '--cascivo-font-size-3xl'
  | '--cascivo-font-size-4xl'
  | '--cascivo-font-size-base'
  | '--cascivo-font-size-lg'
  | '--cascivo-font-size-sm'
  | '--cascivo-font-size-xl'
  ...
  | '--cascivo-link-color'
  | '--cascivo-motion-attention'
  | '--cascivo-motion-drawer'
