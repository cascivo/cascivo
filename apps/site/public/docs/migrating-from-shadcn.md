...
_Generated from the [parity matrix](https://docs.cascivo.com/docs/parity) — 58 of 59 shadcn/ui components have a cascivo equivalent. Each cascivo link carries the exact `cascivo add` command._

| shadcn/ui       | cascivo                                                                       | Notes                                                                       |
| --------------- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| Accordion       | [`accordion`](https://docs.cascivo.com/docs/components/accordion)             |                                                                             |
| Alert           | [`alert`](https://docs.cascivo.com/docs/components/alert)                     |                                                                             |
| Alert Dialog    | [`alert-dialog`](https://docs.cascivo.com/docs/components/alert-dialog)       |                                                                             |
| Aspect Ratio    | [`aspect-ratio`](https://docs.cascivo.com/docs/components/aspect-ratio)       | Queued (v18-t5)                                                             |
| Avatar          | [`avatar`](https://docs.cascivo.com/docs/components/avatar)                   |                                                                             |
| Badge           | [`badge`](https://docs.cascivo.com/docs/components/badge)                     |                                                                             |
| Breadcrumb      | [`breadcrumb`](https://docs.cascivo.com/docs/components/breadcrumb)           |                                                                             |
| Button          | [`button`](https://docs.cascivo.com/docs/components/button)                   |                                                                             |
| Button Group    | [`button-group`](https://docs.cascivo.com/docs/components/button-group)       | Queued (v18-t5)                                                             |
| Calendar        | [`calendar`](https://docs.cascivo.com/docs/components/calendar)               | Queued (v18-t6)                                                             |
| Card            | [`card`](https://docs.cascivo.com/docs/components/card)                       |                                                                             |
| Carousel        | [`carousel`](https://docs.cascivo.com/docs/components/carousel)               | Queued (v18-t6)                                                             |
| Chart           | `chart`                                                                       | chart family via @cascivo/charts                                            |
| Checkbox        | [`checkbox`](https://docs.cascivo.com/docs/components/checkbox)               |                                                                             |
| Collapsible     | [`collapsible`](https://docs.cascivo.com/docs/components/collapsible)         | Queued (v18-t5)                                                             |
| Combobox        | [`combobox`](https://docs.cascivo.com/docs/components/combobox)               |                                                                             |
| Command         | [`command-menu`](https://docs.cascivo.com/docs/components/command-menu)       |                                                                             |
| Context Menu    | [`context-menu`](https://docs.cascivo.com/docs/components/context-menu)       |                                                                             |
| Data Table      | [`data-table`](https://docs.cascivo.com/docs/components/data-table)           |                                                                             |
| Date Picker     | [`date-picker`](https://docs.cascivo.com/docs/components/date-picker)         |                                                                             |
| Dialog          | [`modal`](https://docs.cascivo.com/docs/components/modal)                     |                                                                             |
| Direction       | _by convention_                                                               | RTL via CSS logical properties throughout; no JS provider                   |
| Drawer          | [`sheet`](https://docs.cascivo.com/docs/components/sheet)                     | sheet covers the panel; no mobile swipe gesture. drawer queued (v18-t6)     |
| Dropdown Menu   | [`dropdown`](https://docs.cascivo.com/docs/components/dropdown)               |                                                                             |
| Empty           | [`empty-state`](https://docs.cascivo.com/docs/components/empty-state)         |                                                                             |
| Field           | [`field`](https://docs.cascivo.com/docs/components/field)                     | Queued (v18-t5)                                                             |
| Hover Card      | [`hover-card`](https://docs.cascivo.com/docs/components/hover-card)           |                                                                             |
| Input           | [`input`](https://docs.cascivo.com/docs/components/input)                     |                                                                             |
| Input Group     | [`input-group`](https://docs.cascivo.com/docs/components/input-group)         |                                                                             |
| Input OTP       | [`otp-input`](https://docs.cascivo.com/docs/components/otp-input)             |                                                                             |
| Item            | [`item`](https://docs.cascivo.com/docs/components/item)                       | Queued (v18-t6)                                                             |
| Kbd             | [`kbd`](https://docs.cascivo.com/docs/components/kbd)                         |                                                                             |
| Label           | [`label`](https://docs.cascivo.com/docs/components/label)                     | Queued (v18-t5)                                                             |
| Menubar         | [`menubar`](https://docs.cascivo.com/docs/components/menubar)                 | Queued (v18-t6)                                                             |
| Native Select   | [`native-select`](https://docs.cascivo.com/docs/components/native-select)     | cascivo select is a custom listbox, not the native control. Queued (v18-t6) |
| Navigation Menu | [`navigation-menu`](https://docs.cascivo.com/docs/components/navigation-menu) | Queued (v18-t6)                                                             |
| Pagination      | [`pagination`](https://docs.cascivo.com/docs/components/pagination)           |                                                                             |
| Popover         | [`popover`](https://docs.cascivo.com/docs/components/popover)                 |                                                                             |
| Progress        | [`progress-bar`](https://docs.cascivo.com/docs/components/progress-bar)       | progress-bar + progress-circle                                              |
| Radio Group     | [`radio`](https://docs.cascivo.com/docs/components/radio)                     |                                                                             |
| Resizable       | [`resizable`](https://docs.cascivo.com/docs/components/resizable)             | Queued (v18-t6, a.k.a. splitter)                                            |
| Scroll Area     | [`scroll-area`](https://docs.cascivo.com/docs/components/scroll-area)         | Queued (v18-t5)                                                             |
| Select          | [`select`](https://docs.cascivo.com/docs/components/select)                   |                                                                             |
| Separator       | [`separator`](https://docs.cascivo.com/docs/components/separator)             |                                                                             |
| Sheet           | [`sheet`](https://docs.cascivo.com/docs/components/sheet)                     |                                                                             |
| Sidebar         | [`side-nav`](https://docs.cascivo.com/docs/components/side-nav)               |                                                                             |
| Skeleton        | [`skeleton`](https://docs.cascivo.com/docs/components/skeleton)               |                                                                             |
| Slider          | [`slider`](https://docs.cascivo.com/docs/components/slider)                   |                                                                             |
| Sonner          | [`toast`](https://docs.cascivo.com/docs/components/toast)                     |                                                                             |
| Spinner         | [`spinner`](https://docs.cascivo.com/docs/components/spinner)                 |                                                                             |
| Switch          | [`toggle`](https://docs.cascivo.com/docs/components/toggle)                   |                                                                             |
| Table           | [`data-table`](https://docs.cascivo.com/docs/components/data-table)           |                                                                             |
| Tabs            | [`tabs`](https://docs.cascivo.com/docs/components/tabs)                       |                                                                             |
| Textarea        | [`textarea`](https://docs.cascivo.com/docs/components/textarea)               |                                                                             |
| Toast           | [`toast`](https://docs.cascivo.com/docs/components/toast)                     |                                                                             |
| Toggle          | [`toggle`](https://docs.cascivo.com/docs/components/toggle)                   |                                                                             |
| Toggle Group    | [`toggle-group`](https://docs.cascivo.com/docs/components/toggle-group)       | Queued (v18-t5)                                                             |
| Tooltip         | [`tooltip`](https://docs.cascivo.com/docs/components/tooltip)                 |                                                                             |
| Typography      | [`prose`](https://docs.cascivo.com/docs/components/prose)                     | prose + text + heading                                                      |
...
boxplot, and more). See the [charts overview](https://docs.cascivo.com/docs/charts).
