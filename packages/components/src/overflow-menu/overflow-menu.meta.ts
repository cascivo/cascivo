...
export const meta: ComponentMeta = {
  ...
  deprecated: {
    ...
    replacement: 'menu',
    removeIn: '2.0.0',
    note: 'Menu covers the same trigger-plus-items shape with roving focus, typeahead and submenu support. OverflowMenu keeps working for the whole 1.x line and is removed in 2.0.0.',
  },
  intent: {
    whenToUse: [
