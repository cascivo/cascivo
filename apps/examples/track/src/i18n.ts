...
export const msg = defineMessages('track', {
  ...
  prefDefaultView: 'Default home view',
  prefDefaultViewDesc: 'The view shown when you open the app.',
  prefDefaultViewMyIssues: 'My Issues',
  prefDefaultViewInbox: 'Inbox',
  prefDisplayName: 'Display name',
  prefDisplayNameDesc: 'Your name as displayed across the interface.',
  prefFirstDayOfWeek: 'First day of week',
  prefFirstDayOfWeekDesc: 'Sets the first day of the week in date pickers.',
  prefFirstDayMonday: 'Monday',
  prefFirstDaySunday: 'Sunday',
  prefCtrlEnter: 'Send comment on Ctrl+Enter',
  prefCtrlEnterDesc: 'When enabled, pressing Ctrl+Enter submits comments.',
  ...
  prefThemeDark: 'Dark',
  prefSectionDesktop: 'Desktop',
  prefDesktopNotif: 'Desktop notifications',
  prefDesktopNotifDesc: 'Receive notifications in your desktop browser.',
  prefSectionAutomations: 'Automations',
  prefAutoAssign: 'Auto-assign issues to me',
  prefAutoAssignDesc: 'When you create an issue, automatically assign it to yourself.',
