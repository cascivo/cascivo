...
[`apps/examples/react-vite-ssr`](https://github.com/cascivo/cascivo/tree/main/apps/examples/react-vite-ssr): **357 KB → 29 KB**
...
Measured on [`apps/examples/react-vite-ssr`](https://github.com/cascivo/cascivo/tree/main/apps/examples/react-vite-ssr), a page
...
[smoke test](https://github.com/cascivo/cascivo/blob/main/apps/examples/react-vite-ssr/test/ssr-smoke.mjs) asserts both halves —
