...
export const meta: ComponentMeta = {
  ...
  deprecated: {
    since: '0.17.0',
    replacement: 'menu',
    note: 'Menu covers the same trigger-plus-items shape with roving focus, typeahead and submenu support. OverflowMenu stays for registry compatibility and is removed in v4.',
  },
  intent: {
    whenToUse: [
