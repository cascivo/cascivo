...
<div align="center">
  ...
  <h1>@cascivo/example-ghost-theme</h1>
  <p><strong>A real Ghost (Handlebars) theme styled with cascivo tokens + themes — the executable form of docs/USING-WITH-GHOST.md</strong></p>
