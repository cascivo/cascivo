...
| `@cascivo/email`         | 0.1.0   | —                                                                                        | [CHANGELOG](packages/email/CHANGELOG.md)         |
...
| `@cascivo/i18n`          | 1.2.0   | 1.1.0 — `ColorPicker`'s picking area returned a colour different from the one under the  | [CHANGELOG](packages/i18n/CHANGELOG.md)          |
...
| `@cascivo/react`         | 1.2.0   | 1.2.0 — Enforce the styling contract: a `--cascivo-*` token or `data-cascivo-*` hook tha | [CHANGELOG](packages/react/CHANGELOG.md)         |
...
| `@cascivo/storage`       | 1.2.0   | 1.0.0 — Remove the deprecated surfaces the 1.0 contract clears, and give deprecation an  | [CHANGELOG](packages/storage/CHANGELOG.md)       |
| `@cascivo/themes`        | 1.0.0   | 1.0.0 — Join the `1.x` line.                                                             | [CHANGELOG](packages/themes/CHANGELOG.md)        |
| `@cascivo/tokens`        | 1.1.0   | 1.1.0 — Enforce the styling contract: a `--cascivo-*` token or `data-cascivo-*` hook tha | [CHANGELOG](packages/tokens/CHANGELOG.md)        |
