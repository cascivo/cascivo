...
function generateLlmsTxt(registry: Registry, entries: RegistryEntry[]): string {
  ...
  // Single canonical host. cascivo.com serves the docs, /llms/*, /context/*, and the
  // catalogs at these same paths; docs.cascivo.com is retired (301 → cascivo.com).
  const DOCS = SITE
  ...
  lines.push(`- This file: ${SITE}/llms.txt`)
  lines.push('')
