...
> [`apps/examples/react-next`](../apps/examples/react-next/), the same page drops to
> 34 KB. [`test/rsc-css.mjs`](../apps/examples/react-next/test/rsc-css.mjs) asserts
...
[TESTING.md](./TESTING.md#the-usesignals-gotcha) and
...
HEADLESS.md](./HEADLESS.md#router-integration--client-side-nav-links). After this, every
...
list in the [`@cascivo/react` README](../packages/react/README.md#gotchas--naming-collisions).
...
**Where's a working example?** [`apps/examples/react-next`](../apps/examples/react-next/)
...
- [GETTING-STARTED.md](./GETTING-STARTED.md) — install paths and the theme wiring.
- [CSS-LAYERS-PITFALL.md](./CSS-LAYERS-PITFALL.md) — before adding a global reset
  to `globals.css`.
