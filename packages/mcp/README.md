...
Model Context Protocol server that exposes the [cascade](../../README.md) component registry to AI agents. It reads `registry.json` and offers tools to discover components, read their manifests, add them to a project, generate themes, and scaffold pages.
