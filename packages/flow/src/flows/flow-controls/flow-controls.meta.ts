  ...
  props: [
    {
      name: 'position',
      description:
        'Canvas corner the control cluster is pinned to: `bottom-left`, `bottom-right`, `top-left` or `top-right`.',
    ...
    {
      name: 'showZoom',
      description: 'When true, shows the zoom-in/zoom-out buttons.',
      type: 'boolean',
      required: false,
      default: 'true',
    },
    {
      name: 'showFitView',
      description: 'When true, shows the fit-to-view button.',
      type: 'boolean',
      required: false,
      default: 'true',
    },
    {
      name: 'onZoomIn',
      description: 'Called when the zoom-in control is activated.',
      type: '() => void',
      required: false,
    },
    {
      name: 'onZoomOut',
      description: 'Called when the zoom-out control is activated.',
      type: '() => void',
      required: false,
    },
    {
      name: 'onFitView',
      description: 'Called when the fit-to-view control is activated.',
      type: '() => void',
      required: false,
    },
    {
