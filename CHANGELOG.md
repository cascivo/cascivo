...
| ------------------------ | ------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `@cascivo/ai`            | 0.16.1  | 0.2.0 — AI-layer delivery (audit wave 3):                                                 | [CHANGELOG](packages/ai/CHANGELOG.md)            |
| `@cascivo/charts`        | 0.16.1  | 0.16.0 — Record each component's client-JavaScript cost in its manifest, and stop shippin | [CHANGELOG](packages/charts/CHANGELOG.md)        |
| `cascivo`                | 0.7.2   | 0.7.0 — `doctor` now reports a duplicated `@cascivo/core`.                                | [CHANGELOG](packages/cli/CHANGELOG.md)           |
| `@cascivo/core`          | 0.16.1  | 0.16.0 — Record each component's client-JavaScript cost in its manifest, and stop shippin | [CHANGELOG](packages/core/CHANGELOG.md)          |
...
| `@cascivo/editor`        | 0.16.1  | 0.2.0 — Large-document performance (v47): windowed (viewport-scoped) tokenization. Per-r  | [CHANGELOG](packages/editor/CHANGELOG.md)        |
...
| `@cascivo/flow`          | 0.16.1  | 0.16.0 — Record each component's client-JavaScript cost in its manifest, and stop shippin | [CHANGELOG](packages/flow/CHANGELOG.md)          |
| `@cascivo/i18n`          | 0.16.1  | 0.2.0 — Adoption-audit fixes (waves 1–2):                                                 | [CHANGELOG](packages/i18n/CHANGELOG.md)          |
...
| `@cascivo/react`         | 0.16.1  | 0.16.0 — Record each component's client-JavaScript cost in its manifest, and stop shippin | [CHANGELOG](packages/react/CHANGELOG.md)         |
...
| `@cascivo/storage`       | 0.16.1  | 0.1.0 — Initial public release of the cascivo design system. Includes:                    | [CHANGELOG](packages/storage/CHANGELOG.md)       |
