...
export const meta: ComponentMeta = {
  ...
  props: [
    ...
    },
    {
      ...
      required: false,
      description:
        'Align the internal bands of adjacent children via CSS subgrid — every CardHeader in a row shares one row track, every CardContent the next, every CardFooter the last. Where subgrid is unsupported the grid renders as it does without this prop.',
    },
    {
      name: 'span',
      type: 'number | { base?: number; sm?: number; md?: number; lg?: number; xl?: number }',
  ...
  examples: [
    ...
    {
      title: 'Row-aligned card grid',
      code: '<Grid cols={3} gap={4} alignRows><Card><CardHeader title="A" /><CardContent>Short</CardContent></Card><Card><CardHeader title="A much longer title that wraps" /><CardContent>Long</CardContent></Card></Grid>',
      description:
