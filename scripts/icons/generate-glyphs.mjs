...
function build() {
  ...
  L.push('/* Pure-CSS glyphs via clip-path: shape(). Geometry: packages/icons/src/glyphs/spec.ts. */')
...
console.log(`Wrote ${GLYPHS.length} glyphs + ${MORPHS.length} morph(s) to packages/icons/src/glyphs.css`)
