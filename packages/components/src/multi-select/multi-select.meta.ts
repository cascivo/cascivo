  ...
  intent: {
    ...
    related: [
      ...
      },
      {
        name: 'Combobox',
        relationship: 'alternative',
        reason: 'Use Combobox when users may type values not in the list',
      },
      {
        name: 'Checkbox',
        relationship: 'alternative',
    ...
    content: {
      ...
      notes:
        'Defaults from the i18n catalog; the selected-count and no-results strings are overridable via labels',
    },
    flexibility: [
      {
        area: 'token names',
      ...
      },
      {
        area: 'labels',
        level: 'flexible',
        note: 'placeholder, selected(count), search, and noResults are overridable',
      },
      {
        area: 'options',
        level: 'flexible',
        note: 'Caller supplies the option list and may mark individual options disabled',
      },
    ],
  },
}
