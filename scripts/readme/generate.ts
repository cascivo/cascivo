...
// READMEs render on GitHub and npm, where the SVG is an <img> and cannot inherit
// `currentColor` — so these are the baked, colour-scheme-aware marks, not the
// inheriting logo-mark.svg. They are also NOT favicon.svg: its 62.5% inset and
// 1-unit optical offset are for an icon box and read as stray padding at 72px.
// Two colour for the 72px header, one colour for the 28px footer, where the
// accent is below the size it stays legible at (logo brief §7).
const LOGO = 'https://cascivo.com/logo-mark-img-accent.svg'
const LOGO_SMALL = 'https://cascivo.com/logo-mark-img.svg'
const BRAND = '0079bf'
const AI = '8b5cf6'
...
<div align="center"><a href="https://cascivo.com"><img src="${LOGO_SMALL}" width="28" height="28" alt="cascivo"></a></div>
`
