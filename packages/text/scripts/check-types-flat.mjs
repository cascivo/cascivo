// Fail the build if the published @cascivo/text
// declarations leak the internal monorepo layout. The bundled dist/*.d.ts files
// must reference only external packages (react) — never
