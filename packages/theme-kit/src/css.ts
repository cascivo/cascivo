...
export interface ConfigToCSSOptions {
  /** When true, inline the full base theme token set so the block is
   *  self-contained (used by the live preview). The exported theme omits these —
   *  users import the base theme themselves. */
  previewMode?: boolean
  /** The `data-theme` selector value the generated tokens attach to. */
  themeName?: string
}

export function configToCSS(config: ThemeConfig, options: ConfigToCSSOptions = {}): string {
