...
- [`STYLING-INTERNALS.md`](./STYLING-INTERNALS.md) — layers, `data-cascivo-*` styling hooks
- [`TOKENS.md`](./TOKENS.md) — the full token catalogue
- [`HEADLESS.md`](./HEADLESS.md) — `Presence` and the rest of the behavior layer
- [`THEMING.md`](./THEMING.md) — how a theme tunes motion character
