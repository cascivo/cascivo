  ...
  props: [
    {
      ...
      required: true,
      description:
        'Top bar (typically a ShellHeader). If a React element, its onMenuClick/menuExpanded are bound to the nav toggle.',
    },
    {
      name: 'nav',
      type: 'ReactNode',
    ...
    },
    {
      ...
      required: false,
      description:
        'Initial open state when uncontrolled. Defaults open on desktop, closed on small screens.',
    },
    {
      name: 'onOpenChange',
