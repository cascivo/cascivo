...
- 265e976: `create` gains `--framework astro`, alongside the default `react-vite`.
...
- 265e976: Internal: `pnpm framework:check` builds `cascivo create` output from packed tarballs.
