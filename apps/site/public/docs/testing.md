...
own component suite (198 components, `packages/components/src/*/[name].test.tsx`)
...
the browser — see [TROUBLESHOOTING.md](/docs/troubleshooting.md).)
...
[`packages/components/src/setup.ts`](https://github.com/cascivo/cascivo/blob/main/packages/components/src/setup.ts).
...
- [`packages/components/src/toggle/toggle.test.tsx`](https://github.com/cascivo/cascivo/blob/main/packages/components/src/toggle/toggle.test.tsx) — interaction basics
- [`packages/components/src/modal/modal.test.tsx`](https://github.com/cascivo/cascivo/blob/main/packages/components/src/modal/modal.test.tsx) — dialog polyfills
- [`packages/components/src/search/search.test.tsx`](https://github.com/cascivo/cascivo/blob/main/packages/components/src/search/search.test.tsx) — fake-timer debounce tests
- [TROUBLESHOOTING.md](/docs/troubleshooting.md) — the runtime version of the `useSignals` symptom
