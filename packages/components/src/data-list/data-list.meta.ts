...
export const meta: ComponentMeta = {
  ...
  props: [
    ...
    },
    {
      name: 'orientation',
      description:
        "Where each value sits relative to its own label: 'horizontal' beside it, 'vertical' underneath. Items are stacked vertically in both modes — this does not change the list's own axis.",
  ...
  examples: [
    {
      title: 'Horizontal data list',
      code: `<DataList\n  items={[\n    { label: 'Name', value: 'Ada Lovelace' },\n    { label: 'Role', value: 'Mathematician' },\n  ]}\n/>`,
    },
    {
      title: 'Vertical — value under its label, not "items stacked vertically"',
      description:
  ...
  intent: {
    ...
    related: [
      {
        ...
        reason: 'ContainedList shows single-value rows; DataList shows labelled pairs',
      },
    ],
    a11yRationale:
    ...
    flexibility: [
      {
        area: 'orientation and size',
        level: 'flexible',
        note: 'horizontal for wide panels, vertical for narrow columns; size tunes density',
      },
      {
        area: 'dl semantics',
        level: 'strict',
        note: 'Always renders dl/dt/dd; do not substitute generic elements',
      },
    ],
  },
}
